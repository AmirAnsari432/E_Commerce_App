...
import gr3 from "../images/gr-3.png";
import gr4 from "../images/gr-4.png";
...
const OurStore = () => {
  ...
  return (
    <>
      ...
      <Container class1="storewrapper home-wrapper-2 py-5">
        <div className="row">
          <div className="col-3">
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div className="align-items-center d-flex gap-10">
                  ...
                  <select className="form-control form-select" id="">
                    ...
                    <option value="title-descending">Alphabetcally,Z-A</option>
